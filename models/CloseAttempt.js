...
const closeAttemptSchema = new mongoose.Schema({
  ...
  observedPrice: { type: Number, required: true },
  reason: { type: String, enum: ["TP_HIT", "EXIT_HIT", "ERROR"], required: true },
  result: { type: String, enum: ["INTENT_RECORDED", "CLOSE_EXECUTED", "FAILED", "COOLDOWN_SKIP", "IDEMPOTENT_SKIP"], required: true },
